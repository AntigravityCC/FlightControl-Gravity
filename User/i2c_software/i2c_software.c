...
/* 定义读写SCL和SDA的宏，已增加代码的可移植性和可阅读性 */
	...
	#define I2C_SCL_1()  GPIO_PORT_I2C->BSRR = GPIO_PIN_8				/* SCL = 1 */
	#define I2C_SCL_0()  GPIO_PORT_I2C->BRR = GPIO_PIN_8				/* SCL = 0 */
	
	#define I2C_SDA_1()  GPIO_PORT_I2C->BSRR = GPIO_PIN_9				/* SDA = 1 */
	#define I2C_SDA_0()  GPIO_PORT_I2C->BRR = GPIO_PIN_9				/* SDA = 0 */
	
	#define I2C_SDA_READ()  ((GPIO_PORT_I2C->IDR & GPIO_PIN_9) != 0)	/* 读SDA口线状态 */
#endif
